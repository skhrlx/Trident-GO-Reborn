...
class CSGORender : public OverlayRender
{
    ...
    {        
        ...
        if (csgo_settings::AimbotState > 0)
        {
            ...
            ImGui::SliderIntNew("AimbotFov", &csgo_settings::AimbotFov, 1, 2);
            ImGui::SliderIntNew("AimbotBullets", &csgo_settings::AimbotBullets, 0, 10);
        }
    ...
    void render_visuals_settings()
    {
        ...
        ImGui::CheckboxNew("Enable Bhop", &csgo_settings::Bhop);
        ImGui::CheckboxNew("Enable SoundEsp", &csgo_settings::SoundEsp);
        ImGui::SliderIntNew("SoundEspFov", &csgo_settings::SoundEspFov, 1, 10);
        ImGui::CheckboxNew("AutoAccept", &csgo_settings::AutoAccept);
        ImGui::CheckboxNew("AntiAFK", &csgo_settings::AntiAFK);
    }
    
    void render_settings()
    {
        ImGui::PushFont(mapFont[18]);
        ImGui::Text("Config. Section");
...
public:
    ...
    {
        if (ImGui::IsCustomKeyPressed(VK_DELETE, false))
        {
            exit(0);
        }

        if (ImGui::IsCustomKeyPressed(VK_INSERT, false))
        {
