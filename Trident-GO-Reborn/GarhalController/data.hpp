...
inline bool IsWeaponRifle(int iWeaponID)
{
	return iWeaponID == WEAPON_AK47
		|| iWeaponID == WEAPON_FAMAS
		|| iWeaponID == WEAPON_M4A1
		|| iWeaponID == WEAPON_M4A1_SILENCER
...
inline bool IsWeapon(int iWeaponID)
{
	return iWeaponID == WEAPON_AK47
		|| iWeaponID == WEAPON_FAMAS
		|| iWeaponID == WEAPON_M4A1
		...
		|| iWeaponID == WEAPON_XM1014
		|| iWeaponID == WEAPON_BIZON
...
inline bool IsWeaponSMG(int iWeaponID)
{
	return iWeaponID == WEAPON_MAC10
		|| iWeaponID == WEAPON_P90
		|| iWeaponID == WEAPON_UMP45
		|| iWeaponID == WEAPON_MP7
		|| iWeaponID == WEAPON_MP9
...
inline bool IsWeaponShotgun(int iWeaponID)
{
	return iWeaponID == WEAPON_XM1014
		|| iWeaponID == WEAPON_MAG7
		|| iWeaponID == WEAPON_SAWEDOFF
		|| iWeaponID == WEAPON_NOVA;
}
